...
namespace GateCommunityMvc.Migrations
{
    ...
    [Migration("20230621202236_poll1")]
    partial class poll1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GateCommunityMvc.Models.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GateCommunityMvc.Models.Entryexit", b =>
                {
                    b.Property<int>("eid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GateCommunityMvc.Models.Option", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GateCommunityMvc.Models.Poll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GateCommunityMvc.Models.Entryexit", b =>
                {
                    ...
                    b.HasOne("GateCommunityMvc.Models.SocietyDetails", "society")
                        .WithMany()
                        .HasForeignKey("societyid");

                    b.HasOne("GateCommunityMvc.Models.Visitors", "Visitors")
                        .WithMany()
            ...
            modelBuilder.Entity("GateCommunityMvc.Models.Option", b =>
                {
                    b.HasOne("GateCommunityMvc.Models.Poll", "Poll")
                        .WithMany("Options")
